...
//   - client.html (портал клиента) — ВСЕГДА из сети, НЕ кэшируется,
//     чтобы клиент по ссылке всегда получал свежую страницу и баланс.
...
self.addEventListener('fetch', function(e){
  ...
  // (баланс тянется POST-ом getMyReport, а POST выше уже пропущен.)
  // Так клиент по ссылке всегда видит свежую страницу, без «второго запуска».
  if(url.split('?')[0].indexOf('client.html') !== -1){ return; }
